...
<html lang="en">
<head>
    <title>Code coverage report for lib/lifecycle/loginRequired.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">lib/lifecycle/</a> loginRequired.js
    </h1>
    <div class='clearfix'>
...
exports.loginRequired = function loginRequired(request, next) {
	if (!request.headers || !request.headers.accesstoken) {
		...
		var headers = request.headers || <span class="branch-1 cbranch-no" title="branch not covered" >{},</span>
