...
<html lang="en">
<head>
    <title>Code coverage report for lib/utility/getObject.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">lib/utility/</a> getObject.js
    </h1>
    <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >		throw new Error('invalid SF object named:' + name);</span>
	}
	return obj;
};
&nbsp;</pre></td></tr>
