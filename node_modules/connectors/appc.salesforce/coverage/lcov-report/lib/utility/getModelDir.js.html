...
<html lang="en">
<head>
    <title>Code coverage report for lib/utility/getModelDir.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">lib/utility/</a> getModelDir.js
    </h1>
    <div class='clearfix'>
...
function ensureExists(dir) {
	<span class="missing-if-branch" title="else path not taken" >E</span>if (!fs.existsSync(dir)) {
		fs.mkdirSync(dir);
	}
}
&nbsp;</pre></td></tr>
